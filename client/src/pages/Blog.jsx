...
function Blog() {
  ...
  const addComment = async(e)=>{
   ...
   try{
    ...
    if(data.success){
      // console.log("Sending comment:", { blogId: id, name, content });
  ...
  return data ? (
    ...
    <Navbar/>
      ...
      <div className='flex'>
        ...
        <img src={assets.twitter_icon} width={50} alt='teittericon'/>
        <img src={assets.googleplus_icon} width={50} alt='googleicon'/>
      </div>
     </div> 
