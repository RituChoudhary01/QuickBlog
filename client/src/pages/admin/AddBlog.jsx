  ...
  return (
   <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
    ...
    <div className='w-8 h-8 rounded-full border-2 border-t-white animate-spin'>
      ...
      <button disabled={loading} className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer' onClick={generateContent} type='button'>Generate with AI</button>
    </div>
